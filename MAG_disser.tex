...
\textbf{\Large 
		<<Конструктор курсов для интеллектуальной обучающей системы на основе когнитивного моделирования>>
	}
...
% должность, научная степень руководителя	
    Руководитель ВКР,\\доцент отделения ИКС, к.т.н. & \useFRMfield{xtitlesign} & Фонталина~Е.С. \\
	& & \\
